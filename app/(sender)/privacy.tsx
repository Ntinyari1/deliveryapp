...
import { useRouter } from 'expo-router';
import { LinearGradient } from 'expo-linear-gradient';
import { ArrowLeft, Shield, Eye, MapPin, Share2, Lock, FileText, ChevronRight } from 'lucide-react-native';
  ...
  const privacyGroups = [
    {
      ...
      items: [
        { 
          key: 'shareLocation', 
          label: 'Share Location', 
          description: 'Allow riders to see your location during delivery' 
        },
      ]
    },
    {
      ...
      items: [
        { 
          ...
          label: 'Share Delivery History', 
          description: 'Allow TumaRide to use your delivery data for service improvement' 
        },
        { 
    ...
    },
    {
      ...
      items: [
        { 
          key: 'profileVisibility', 
          label: 'Profile Visibility', 
          description: 'Allow your profile to be visible to riders' 
        },
        { 
          key: 'marketingEmails', 
          label: 'Marketing Emails', 
            ...
            {group.items.map((item, itemIndex) => (
              <View key={itemIndex} style={styles.privacyItem}>
                ...
                <Switch
                  ...
                  thumbColor={privacySettings[item.key] ? '#ffffff' : '#f4f3f4'}
                />
              </View>
            ))}
          </View>
          ...
          {privacyActions.map((action, index) => (
            <TouchableOpacity key={index} style={styles.actionCard} onPress={action.action}>
              <View style={styles.actionIcon}>
                <action.icon color="#666666" size={20} />
              </View>
              <View style={styles.actionInfo}>
